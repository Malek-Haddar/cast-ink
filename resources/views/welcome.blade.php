...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <!--  include './partials/header.php' -->
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="audio-cmn-title">
                            <a href="episode-details.php" class="black-clr d-block fs20 fw-700 body-font">
    ...
    <!-- Custom Search Start -->
    <!-- include './partials/search-wrap.php'  -->
    <!-- Custom Search End -->
                ...
                <div class="swiper latest-episodewrap">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="latest-episode-itemv1">
                                <div class="thumb overflow-hidden w-100">
                                    <img src="assets/img/podcast/episode1.png" alt="img" class="overflow-hidden w-100">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="latest-episode-itemv1">
                                <div class="thumb overflow-hidden w-100">
                                    <img src="assets/img/podcast/episode2.png" alt="img" class="overflow-hidden w-100">
                                </div>
                                <div class="content p-xxl-8 p-xl-6 p-lg-5 p-4">
                                    <div class="fashion-life d-flex align-items-center gap-2 mb-xxl-5 mb-xl-3 mb-3">
                                        <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="swiper-slide">
                            <div class="latest-episode-itemv1">
                                <div class="thumb overflow-hidden w-100">
                                    <img src="assets/img/podcast/episode3.png" alt="img" class="overflow-hidden w-100">
                                </div>
                                <div class="content p-xxl-8 p-xl-6 p-lg-5 p-4">
                                    <div class="fashion-life d-flex align-items-center gap-2 mb-xxl-5 mb-xl-3 mb-3">
                                        <div class="d-flex align-items-center gap-2">
    ...
    <!-- Scroll Top Start -->
     <!--  include './partials/scroll-up.php' -->
    <!-- Scroll Top End -->


    <!-- Cmn Popup Audio Player Wrap -->
     <!--  include './partials/cmn-popup.php' -->
    <!-- Cmn Popup Audio Player Wrap -->
